...
import { rx_all_rooms, rx_all_msgs } from "../modules/chats";
...
/* function */
import { socket, cm_all_users, cm_all_rooms, cm_all_msgs, cm_logout } from "../helpers/common";
...
const Home = ({ rx_all_users, rx_all_rooms, rx_all_msgs,  me, rx_authenticated }) => {
